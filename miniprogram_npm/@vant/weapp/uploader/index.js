'use strict';
import {appendCookieToUrl} from "../../../../utils/util";
...
component_1.VantComponent({
  ...
  data: {
    lists: [],
    isInCount: true,
      /*start added by wanglong*/
      showSheet:false,
      /*end added by wanglong*/
  },
  methods: {
      /*start added by wanglong*/
      onClose() {
      ...
      onSelect(event){
          const {accept,capture} = event.detail
          this.startUpload({accept,capture})
      },
      showActions(){
    ...
    formatFileList: function () {
      ...
      var lists = fileList.map(function (item) {
        var {url} = item
        return __assign(__assign({}, item,{url:appendCookieToUrl(url)}), {
          isImage:
    ...
    startUpload: function (overwrites) {
      var _this = this;
      var _a = this.data,
        maxCount = _a.maxCount,
      ...
      utils_1
        .chooseFile(
          ...
          },/*start added by wanglong*/overwrites/*end added by wanglong*/)
        )
        .then(function (res) {
          var file = null;
